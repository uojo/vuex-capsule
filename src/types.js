...
// mutation
export const M_MOD_SET = 'entity/set'
export const M_MOD_RESET = 'entity/reset'
export const M_MOD_RECEIVED = 'entity/get/received'
// action
// export const SEND_REQUEST = 'entity/send/request'  => rename: entitySend
// mutation
export const M_SEND_RECEIVED = 'entity/send/request/received'
export const M_SEND_ERROR = 'entity/send/request/error'
